...
export const A = forwardRef<NativeText, StyledProps<AProps>>(function A({ className = "", href, target, ...props }, ref) {
	...
	return <Text accessibilityRole="link" className={`text-blue-500 hover:underline ${className}`} {...props} {...nativeAProps} ref={ref} />;
});
 ...
 */
export const TextLink = styled<ComponentProps<typeof SolitoTextLink> & { style?: TextStyle }>(function TextLink({ style, textProps, ...props }) {
