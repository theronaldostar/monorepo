type useMergeTwinsProps = Record<string, string | number | boolean>;

const useMergeTwins = <T extends useMergeTwinsProps>(obj1: T, obj2: T): T => {
...
export { useMergeTwins, type useMergeTwinsProps };
